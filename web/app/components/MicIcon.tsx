...
/**
 * Props for the MicIcon component.
 * @prop className Optional class name for styling.
 * @prop onClick Optional click handler for the icon.
 */
...
export default function MicIcon({ className, onClick, ...props }: IMicIconProps) {
  return (
    <svg
      width="142"
      height="142"
      ...
      {...props}
    >
      <path fillRule="evenodd" clipRule="evenodd" d="M121 71C121 43.3858 98.6142 21 71 21C43.3858 21 21 43.3858 21 71C21 98.6142 43.3858 121 71 121C98.6142 121 121 98.6142 121 71Z" fill="white"/>
      ...
      <circle cx="71" cy="71" r="61" stroke="url(#paint0_linear_1_3)" strokeWidth="20"/>
      <defs>
